...
<div id="wrap-vp">
    ...
    <div id="menu-vp">
      ...
      <div id="midheader-vp">
        ...
        <!-- <div id="right">
            ...
            <?php require_once('blocks/thongtinchung.php') ?>
        </div> -->
    </div>
    <div class="clear"></div>
    ...
    <div id="slide-vp">
        ...
        <?php require_once('blocks/top_trang_chu.php') ?>

        <div id="slide-right">
        <!--blocks/quangcao_top_phai.php-->
        <?php require_once('blocks/quangcao_top_phai.php') ?>
        </div>
    </div>
  	...
  	<div id="content-vp">
    	<div id="content-left">
		<!--blocks/cot_trai.php-->
        <?php require_once('blocks/cot_trai.php') ?>
        </div>
        <div id="content-main">
            ...
            <?php
                if(isset($_GET['page'])){
                    switch ($_GET['page']) {
                        ...
                        case 'timkiem':
                            require_once('pages/timkiem.php');
                            break;
                    }
                }
                else{
		...
		<!--blocks/cot_phai.php-->
        <?php require_once('blocks/cot_phai.php') ?>
        </div>
    ...
    <!-- <div id="thongtin">
        ...
        <?php require_once('blocks/thongtindoanhnghiep.php') ?>
    </div> -->
    <div class="clear"></div>
    <div id="footer">
    	<!--blocks/footer.php-->
